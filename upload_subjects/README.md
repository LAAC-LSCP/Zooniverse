...
If you are not part of the project, you will get the following error:

```
panoptes_client.panoptes.PanoptesAPIException: Couldn't find linked project for current user
```
